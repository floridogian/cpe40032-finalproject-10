...
public class PatrolState : StateMachineBehaviour
{
    ...
    private float chaseRange = 15.0f;   // The maximum distance the enemy can see the player and start chasing them
    private float timeToIdle = 10.0f;  // Waiting time for enemy to stop patrolling and go on idle state
